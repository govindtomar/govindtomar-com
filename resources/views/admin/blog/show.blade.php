        ...
        <div class="card">
            ...
            <div class="card-body">                        
                <div class="row pb-4">                           
                    ...
                    <div class="col-lg-9">{{ $blog->name }}</div>
                </div> 
                                        <div class="row pb-4">                           
                                            <div class="col-lg-3">User</div>
                                            <div class="col-lg-9">{{ $blog->user->name }}</div>
                                        </div> 
                <div class="row pb-4">                           
                    <div class="col-lg-3">Slug</div>
                    <div class="col-lg-9">{{ $blog->slug }}</div>
                </div> 
                <div class="row pb-4">                           
                    <div class="col-lg-3">Path</div>
                    <div class="col-lg-9">{{ $blog->path }}</div>
                </div> 
                <div class="row pb-4">                           
                    <div class="col-lg-3">Description</div>
                    <div class="col-lg-9">{{ $blog->description }}</div>
                </div> 
                <div class="row pb-4">                           
                ...
                <div class="row pb-4">                           
                    ...
                    <div class="col-lg-9">{{ $blog->meta_title }}</div>
                </div> 
                <div class="row pb-4">                           
                    <div class="col-lg-3">Meta description</div>
                    <div class="col-lg-9">{{ $blog->meta_description }}</div>
                </div> 
                <div class="row pb-4">                           
                    <div class="col-lg-3">Meta keyword</div>
                    <div class="col-lg-9">{{ $blog->meta_keyword }}</div>
                </div> 
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <ul style="display: inline-flex; float:right;">
                    <li>
                        <a href="{{ url('admin/blog/create') }}" class="btn btn-primary"><i class="{{ config('crud.plus_icon') }}"></i></a>
                    </li>
                    <li>
                        <a href="{{ url('admin/blog/'. $blog->id.'/edit') }}" class="btn btn-success"><i class="{{ config('crud.edit_icon') }}"></i></a>
                    </li>
                    <li>
                        <form id="back-delete-form" action="{{ url('admin/blog', [$blog->id]) }}" method="POST">
                            @csrf
                            {{method_field('DELETE')}}
